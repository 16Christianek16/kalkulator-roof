  ...
  return (
    <div className="min-h-screen flex" style={{ background: '#f1f5f9' }}>
      ...
      <div className="hidden lg:flex flex-col justify-between w-96 p-10 shrink-0"
        style={{ background: 'linear-gradient(160deg, var(--wood-dark) 0%, #1e293b 100%)' }}>
        ...
        <div className="w-full max-w-sm">
          <div className="mb-8">
            <div className="flex items-center gap-2 mb-6 lg:hidden">
              ...
              <span className="font-bold text-base" style={{ color: 'var(--wood-dark)' }}>CalkulatorRoof</span>
            </div>
            <h1 className="text-2xl font-bold" style={{ color: 'var(--wood-dark)' }}>Přihlášení</h1>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <button type="submit" disabled={loading}
              ...
              style={{ background: 'linear-gradient(135deg, var(--amber), var(--amber-light))', boxShadow: '0 4px 12px rgba(37,99,235,0.3)' }}>
          ...
          <p className="mt-6 text-center text-sm" style={{ color: '#64748b' }}>
            Nemáte účet?{' '}
            <Link to="/registrace" className="font-semibold hover:underline" style={{ color: 'var(--amber)' }}>
